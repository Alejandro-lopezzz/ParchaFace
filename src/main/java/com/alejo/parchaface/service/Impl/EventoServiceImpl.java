...
public class EventoServiceImpl implements EventoService {
    ...
    public Evento crearEvento(CrearEventoForm form, MultipartFile imagenPortada, Usuario organizador) {
        ...
        // Imagen (archivo real)
        // ======================
        // ✅ Si el controller no la manda aparte, intentamos obtenerla del form
        MultipartFile file = imagenPortada;
        if (file == null) {
            try {
                file = form.getImagenPortada(); // si tu form YA tiene imagenPortada
    ...
    private SavedImage saveCoverToDisk(MultipartFile file) {
        try {
            ...
            // Si no trae extensión, asigna por content-type
            if (ext.isBlank()) {
            ...
            // ✅ Seguridad: asegurar que quede dentro de uploads/eventos
